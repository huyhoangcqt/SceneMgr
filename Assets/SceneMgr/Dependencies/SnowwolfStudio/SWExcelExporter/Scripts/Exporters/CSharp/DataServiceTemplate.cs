public static class DataServiceTemplate
{
    public const string dataServiceFileCode = @"//This file is generated by excel exporter. If you want to change the workflow, see 'DataServiceTemplate' class in ExcelExporter first.
